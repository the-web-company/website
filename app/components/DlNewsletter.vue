    ...
    <div class="hidden md:grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
      <div class="flex flex-col items-start">
        <div class="flex sm:flex-col items-center sm:items-start gap-4 sm:gap-0">
          <div class="rounded-md bg-primary-200 p-2 w-10 h-10">
            <UIcon name="i-heroicons-calendar-days" class="h-6 w-6 text-primary-500" />
          </div>
          <h3 class="sm:mt-4 font-semibold">Monthly update</h3>
        </div>
        <p class="mt-2 text-sm text-gray-500">A monthly summary of everything that happened in TheWebCo. Every important feature, and new update.</p>
      </div>
      <div class="flex flex-col items-start">
        <div class="flex flex-row sm:flex-col items-center sm:items-start gap-4 sm:gap-0">
          <div class="rounded-md bg-primary-200 p-2 w-10 h-10">
            <UIcon name="i-heroicons-hand-raised" class="h-6 w-6 text-primary-500" />
          </div>
          <h3 class="sm:mt-4 font-semibold">No spam</h3>
        </div>
        <p class="mt-2 text-sm text-gray-500">We hold ourselves to the highest standards and commit to not flood your inbox and never send spam emails.</p>
      </div>
    </div>
  </div>
</template>
