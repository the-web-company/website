...
<template>
  <div class="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-16 items-center">
    <div class="max-w-64 md:max-w-80 lg:max-w-96 xl:max-w-md overflow-x-hidden p-4 bg-purple-950 ring-1 ring-purple-700 z-20 rounded-md">
    ...
    <div class="p-4 bg-purple-950 ring-1 ring-purple-700 rounded-md scale-75 -mt-10 lg:-mt-0 lg:-ml-20">
      <DIGeneral />
    </div>
  </div>
</template>
