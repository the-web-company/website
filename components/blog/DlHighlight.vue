...
<template>
  <article class="flex flex-col-reverse justify-between sm:flex-row gap-2 sm:gap-8">
    ...
    <div class="sm:w-1/2">
      <a :href="post._path">
        <img :src="post.featuredImage" alt="post featured image" class="w-full rounded-md object-cover h-80" />
      </a>
    </div>
  </article>
</template>
